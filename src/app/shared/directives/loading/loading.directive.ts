...
export class LoadingDirective implements OnInit, OnChanges {
  ...
  ngOnInit() {
    ...
    this.renderer.setStyle(loadingContainer, 'border-radius', '8px');
    this.renderer.setStyle(loadingContainer, 'background', '#808080');
    ...
    this.renderer.addClass(spinnerContainer, 'lds-hourglass');
